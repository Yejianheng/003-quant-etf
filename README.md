...
| 指标 | **50/50 组合** | 纯A(无sf) | 纯B(sf+0.08) | 沪深300 | 纳指 |
|------|:---:|:---:|:---:|---------|--------|------|
| Sharpe | **1.108** | 1.017 | 1.206 | 0.19 | 0.20 |
| 年化 | **10.47%** | 11.72% | 9.06% | 4.8% | 6.5% |
| 最大回撤 | **-9.66%** | -13.91% | -7.45% | -46.3% | -85.5% |
| 2018 年 | **-6.2%** | -8.6% | -3.6% | — | — |

> **推荐 50/50 组合**：50% 资金 A（无 sf） + 50% 资金 B（sf+0.08），各自独立运行不调仓。低波动时跟 A 满仓吃肉，高波动时被 B 托住少亏。Sharpe 1.108，回撤 -9.66%，年化 10.47%。
